...
class ImageProcessor:
    ...
    def get_image_list(self):
        data_org = os.path.join(self.data_dir, 'snack_dataOrg2')
    ...
    def make_save_path(self, img_name):
        data_path = os.path.join(self.data_dir, 'snack_dataOrg2_640')
    ...
    # snack_dataOrg_640 폴더에 있는 이미지 크기 출력
...
def main():
    ...
    processor.print_image_sizes()  # 변환된 이미지 크기 출력
