...
def apply_random_transformations(image, bboxes, category_ids):
    ...
    ], bbox_params=A.BboxParams(format='yolo', label_fields=['class_labels'], min_area=0.1, min_visibility=0.8,clip=True))
...
# 예제 사용
image_folder = '4th_data_label_class_only_split_4times/train/images'
label_folder = '4th_data_label_class_only_split_4times/train/labels'

process_images_in_folder_random(image_folder, label_folder, num_variations=1.5)
